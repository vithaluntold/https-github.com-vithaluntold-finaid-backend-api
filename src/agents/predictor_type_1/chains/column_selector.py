...
prompt_column_selector = ChatPromptTemplate(
    [
        (
            ...
            1. Pick the column name which best describes the term "Transaction Details"
            2. Pick the column name which best describes the term "Transaction Amount"
                - if no such column exists, return null
            3. Pick the column name which best describes the term "Transaction Type" (whether it was a debit or a credit transaction).
                ...
                - if no such column exists, return null
            4. Pick the column name which best describes the term "Debit Amount"
                - if no such column exists, return null
            5. Pick the column name which best describes the term "Credit Amount"
                - if no such column exists, return null
            6. Finally identify the type of the spreadsheet:
            ...
            Example 1:
            Input given to you: 
            [Trx data, Time, Amount(INR), Balance(INR), Chq Details, Acc no.,  Transaction Particulars, Id, Cr / Dr]
